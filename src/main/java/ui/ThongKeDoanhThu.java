...
//        panel.setBackground(new Color(238, 232, 170));
        ...
        comboBoxNgay.setModel(new DefaultComboBoxModel(
        ...
        comboBoxThang.setModel(new DefaultComboBoxModel(
    ...
    private void updateTable(List<HoaDon> ds) {
        ...
        for (HoaDon hd : ds) {
            ...
            Object row[] = { hd.getMaHD(), hd.getNgayLapHD(), hd.getNhanVien().getTenNV(), hd.getBan().getTenBan(),
                    hd.getKhachHang().getTenKH(), tongTien };
            model.addRow(row);
        }
    }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                if(maNVTK.equals("")) {
                    ...
                    new ThongKeDoanhThu(null).dispose();
                }else {
